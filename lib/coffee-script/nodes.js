(function() {
  ...
  exports.Block = Block = (function() {
    ...
    Block.prototype.compile = function(o, level) {
      if (o == null) o = {};
      o.indent || (o.indent = "");
      return "" + o.indent + (o.scope ? Block.__super__.compile.call(this, o, level) : this.compileRoot(o));
    };
  ...
  exports.Literal = Literal = (function() {
    ...
    Literal.prototype.compileNode = function(o) {
      ...
      code = this.isUndefined ? "(void 0)" : this.value === 'this' ? ((_ref2 = o.scope.method) != null ? _ref2.bound : void 0) ? o.scope.method.context : this.value : this.value.reserved && ((_ref3 = "" + this.value) !== 'eval' && _ref3 !== 'arguments') ? "\"" + this.value + "\"" : this.value;
      if (this.isStatement()) {
  ...
  exports.Op = Op = (function() {
    ...
    Op.prototype.compileNode = function(o) {
      ...
      return "(" + this.operator + " " + (this.first.compile(o, LEVEL_OP)) + " " + (this.second.compile(o, LEVEL_OP)) + ")";
    };
  ...
  exports.If = If = (function() {
    ...
    If.prototype.compileStatement = function(o) {
      ...
      return ifPart + (this.isChain ? (o.indent = this.tab, o.chainChild = true, (this.elseBody.unwrap().compile(o, LEVEL_TOP)) + ")") : "\n" + (this.elseBody.compile(o, LEVEL_TOP)) + "\n" + this.tab + ")");
    };
